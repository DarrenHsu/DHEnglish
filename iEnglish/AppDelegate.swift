...
//  iEnglish
//
//  Created by Dareen Hsu on 11/18/15.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        MagicalRecord.setupCoreDataStack(withAutoMigratingSqliteStoreNamed: "iEnglish")
    ...
    func setDefaultNavigationController() {
        ...
        let vc : PageViewController = storyboard.instantiateViewController(withIdentifier: "PageViewController") as! PageViewController
